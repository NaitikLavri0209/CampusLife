        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              <label className="mb-1 text-[#B19EEF]">Full Name</label>
              <input
                type="text"
                required
                className="bg-white/10 backdrop-blur-md border border-[#B19EEF]/40 rounded px-3 py-2 text-white outline-none focus:border-[#B19EEF] focus:ring-1 focus:ring-[#B19EEF]"
              />
            </div>

            <div className="flex flex-col">
              <label className="mb-1 text-[#B19EEF]">Student ID</label>
              <input
                type="text"
                required
                className="bg-white/10 backdrop-blur-md border border-[#B19EEF]/40 rounded px-3 py-2 text-white outline-none focus:border-[#B19EEF] focus:ring-1 focus:ring-[#B19EEF]"
